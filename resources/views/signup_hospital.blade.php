...
>
  <head>
    ...
    <title>MyVitalz - Signup for Hospitals</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card mv-card-glass">
            <div class="card-body p-4 p-md-5">
             ...
             <?php } ?>
              <h4 class="mv-auth-title text-center mb-3">Create your hospital account</h4>
              <p class="text-center mv-helper mb-4">Manage staff, appointments and patient referrals</p>
              <form class="mb-3" method="POST" >
                   <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>"> 
               
                  <p class="text-center text-primary d-none">Sign up as a Hospital</p>
