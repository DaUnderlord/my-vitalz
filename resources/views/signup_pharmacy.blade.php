...
>
  <head>
    ...
    <title>MyVitalz - Signup for Pharmacy</title>
            ...
            <div class="card-body p-4 p-md-5">
             ...
             <?php 
              ...
              <div class="alert alert-danger mb-4"><?php echo $rtn; ?></div> 
                ...
                ?>
              <h4 class="mv-auth-title text-center mb-3">Create your pharmacy account</h4>
              <p class="text-center mv-helper mb-4">Manage inventory, e‑prescriptions and patient monitoring</p>
              <form class="mb-3" method="POST" >
                   <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>"> 
               
                  <p class="text-center text-primary d-none">Sign up as a Pharmacy</p>
