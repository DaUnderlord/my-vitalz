...
>
  <head>
    ...
    <title>MyVitalz - Signup for Doctors</title>
            ...
            <div class="card-body p-4 p-md-5">
             ...
             <?php 
              ...
              <div class="alert alert-danger mb-4"><?php echo $rtn; ?></div> 
                ...
                ?>
              <h4 class="mv-auth-title text-center mb-3">Create your doctor account</h4>
              <p class="text-center mv-helper mb-4">Manage visits, prescriptions and your virtual pharmacy</p>
              <form class="mb-3" method="POST" >
                   <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>"> 
               
                  <p class="text-center text-primary d-none">Sign up as a Doctor</p>
                ...
                <div class="mb-3 form-password-toggle mv-input">
                 ...
                 <div class="mb-3 mv-input">
                  ...
                  <input type="text" class="form-control"  name="license"  placeholder="License type"  required/>
                </div> 
