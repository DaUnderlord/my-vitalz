            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
               <!--  <div class="col-md-12 mb-4">
                     <button type="button" class="btn btn-danger me-4 mb-2">
                              <span class="tf-icons bx bx-plus"></span>&nbsp; Add Patient
                            </button>  
                    
                  <button type="button" class="btn btn-success me-4 mb-2" data-bs-toggle="modal"
                          data-bs-target="#DropModalReadings">
                              <span class="tf-icons bx bx-vial"></span>&nbsp; Take Readings
                            </button>  
                    
                    <button type="button" class="btn btn-primary mb-2">
                              <span class="tf-icons bx bx-desktop"></span>&nbsp; Request a device
                            </button> 
                  </div>-->
                <div class="col-md-12">
                <div class="row">
                    ...
                    <ul class="nav nav-pills mb-3" role="tablist">
                      ...
                      <li class="nav-item">
                        <button
                          ...
                          role="tab"
                          data-bs-toggle="tab"
                          data-bs-target="#navs-pills-top-patients"
                          aria-controls="navs-pills-top-patients"
                          aria-selected="false"
                                onclick="show_patient()"
                        >
                          My Patients
                        ...
                        <button
                          ...
                          role="tab"
                          data-bs-toggle="tab"
                          data-bs-target="#navs-pills-hospital-requests"
                          aria-controls="navs-pills-hospital-requests"
                          aria-selected="false"
                        ...
                        <button
                          ...
                          role="tab"
                          data-bs-toggle="tab"
                          data-bs-target="#navs-pills-pharmacy-requests"
                          aria-controls="navs-pills-pharmacy-requests"
                          aria-selected="false"
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                ...
                ?>
                      ...
                      <div class="tab-pane fade" id="navs-pills-top-patients" role="tabpanel">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                ...
                ?>
                    ...
                    <div class="tab-pane fade" id="navs-pills-pharmacy-requests" role="tabpanel">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                ...
                ?>
                    ...
                    <div class="tab-pane fade" id="navs-pills-hospital-requests" role="tabpanel">
